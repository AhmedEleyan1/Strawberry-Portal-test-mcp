        ...
        {step === 1 ? (
          ...
          <div className="modal-step">
            ...
            <div id="modal-rating-outcomes-container">
              {creditRating === 'Contact Credit Team' && isRatedToday && (
                <>
              ...
              {creditRating === 'Payment upfront' && isRatedToday && (
                <>
                  <div className="modal-alert-box">
                    <div className="modal-alert-text">
                      Invoicing is not recommended. For questions,{' '}
                      <a href="#" className="brand-link" style={{ color: 'var(--selection-accent)' }}>
                        contact credit team
                      </a>.
                    </div>
                  </div>
          ...
          <div className="modal-step">
            ...
            <div className="modal-body-text">
              {isCentralAgreement ? (
                <>
                  The customer is covered by a central agreement which dictates what payment terms are available. <br/>
                  <span style={{ display: 'block', marginTop: '8px', fontWeight: 500, color: 'var(--text-link)' }}>
                    For questions or requests for other payment terms, <a href="#" className="brand-link">contact Sales</a>.
                  </span>
                </>
              ) : (
            ...
            <div className="modal-form-group">
              ...
              {paymentTermsError && <div className="error-message" style={{ display: 'block' }}>Please select payment terms.</div>}
            </div>
            ...
            <div className="modal-form-group" style={{ position: 'relative' }}>
              ...
              <div style={{ position: 'relative', display: 'flex', alignItems: 'center' }}>
                ...
                />
                <svg className="calendar-input-icon" viewBox="0 0 24 24" style={{ position: 'absolute', right: '12px', width: '20px', height: '20px', fill: 'var(--text-secondary)', pointerEvents: 'none' }}>
              ...
              {estimatedDateError && <div className="error-message" style={{ display: 'block' }}>Please select an estimated invoice date.</div>}
