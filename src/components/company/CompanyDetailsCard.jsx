  ...
  return (
    <Card className="details-card" aria-label="Company Details">
      <div className="card-grid">
        ...
        <div className="grid-column">
          <div className="details-field no-direct-edit" data-field-id="company_name">
            ...
            <div className="field-value-container">
              <span className="field-value" style={{ fontWeight: 500 }}>{state.companyName}</span>
            </div>
          </div>
        ...
        <div className="grid-column">
          <div className="details-field no-direct-edit" data-field-id="credit_rating">
            ...
            <div className="field-value-container" style={{ justifyContent: 'flex-start' }}>
          ...
          <div className="details-field no-direct-edit" data-field-id="credit_rating_last_checked">
            ...
            <div className="field-value-container" style={{ justifyContent: 'flex-start', gap: '12px' }}>
              ...
              <button 
                ...
                style={{ background: 'none', border: 'none', fontFamily: 'var(--font-family-body)', fontSize: '14px', color: 'var(--text-link)', textDecoration: 'underline', cursor: 'pointer', padding: 0 }}
              >
                Update
              </button>
            </div>
        ...
        <div className="grid-column">
          <div className="details-field no-direct-edit" data-field-id="company_payment_terms">
            ...
            <div className="field-value-container" style={{ justifyContent: 'flex-start', gap: '12px' }}>
              <span className="field-value" id="display-payment-terms" style={{ fontWeight: 600 }}>
          ...
          <div className="details-field no-direct-edit" data-field-id="main_contract_holder">
            ...
            <div className="field-value-container" style={{ justifyContent: 'flex-start' }}>
              <span className="field-value"><a href="/index.html" onClick={handleContractClick} className="brand-link">Strawberry Holding AS</a></span>
            </div>
          </div>
      ...
      <details className="more-info-details">
        ...
        <div className="card-divider" style={{ marginTop: 0 }}></div>
        <div className="card-grid">
          <div className="grid-column">
